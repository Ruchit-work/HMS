...
import TabSkeleton, { tabSkeletonForTab } from "@/components/ui/feedback/TabSkeleton"
...
export const prefetchReceptionistTab = (tab: ReceptionistTab) => {
  switch (tab) {
    case "dashboard":
      void import("@/app/receptionist-dashboard/Tabs/DashboardOverview")
      break
    case "patients":
      void import("@/app/admin-dashboard/Tabs/PatientManagement")
      void import("@/app/admin-dashboard/Tabs/PatientAnalytics")
      break
    case "doctors":
      void import("@/app/admin-dashboard/Tabs/DoctorManagement")
      break
    case "appointments":
      void import("@/app/admin-dashboard/Tabs/AppoinmentManagement")
      break
    case "admit-requests":
      void import("@/app/receptionist-dashboard/Tabs/AdmitRequestsPanel")
      break
    case "billing":
      void import("@/app/receptionist-dashboard/Tabs/BillingHistoryPanel")
      break
    case "book-appointment":
      void import("@/app/receptionist-dashboard/Tabs/BookAppointmentPanel")
      break
    case "whatsapp-bookings":
      void import("@/app/receptionist-dashboard/Tabs/WhatsAppBookingsPanel")
      break
    case "documents":
      void import("@/components/documents/DocumentsTab")
      break
  }
}

const DashboardOverview = dynamic(
  () => import("@/app/receptionist-dashboard/Tabs/DashboardOverview"),
  { loading: () => <TabSkeleton variant="dashboard" /> }
)
const PatientManagement = dynamic(
  () => import("@/app/admin-dashboard/Tabs/PatientManagement"),
  { loading: () => <TabSkeleton variant="table" /> }
)
const PatientAnalytics = dynamic(
  () => import("@/app/admin-dashboard/Tabs/PatientAnalytics"),
  { loading: () => <TabSkeleton variant="table" /> }
)
const DoctorManagement = dynamic(
  () => import("@/app/admin-dashboard/Tabs/DoctorManagement"),
  { loading: () => <TabSkeleton variant="table" /> }
)
const AppoinmentManagement = dynamic(
  () => import("@/app/admin-dashboard/Tabs/AppoinmentManagement"),
  { loading: () => <TabSkeleton variant="table" /> }
)
const AdmitRequestsPanel = dynamic(
  () => import("@/app/receptionist-dashboard/Tabs/AdmitRequestsPanel"),
  { loading: () => <TabSkeleton variant="ipd" /> }
)
const BillingHistoryPanel = dynamic(
  () => import("@/app/receptionist-dashboard/Tabs/BillingHistoryPanel"),
  { loading: () => <TabSkeleton variant="billing" /> }
)
const BookAppointmentPanel = dynamic(
  () => import("@/app/receptionist-dashboard/Tabs/BookAppointmentPanel"),
  { loading: () => <TabSkeleton variant="form" /> }
)
const WhatsAppBookingsPanel = dynamic(
  () => import("@/app/receptionist-dashboard/Tabs/WhatsAppBookingsPanel"),
  { loading: () => <TabSkeleton variant="table" /> }
)
const DocumentsTab = dynamic(
  () => import("@/components/documents/DocumentsTab"),
