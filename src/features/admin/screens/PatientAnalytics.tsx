...
import { formatDate, calculateAge } from '@/shared/utils/shared/date'
...
export default function PatientAnalytics() {
  ...
  const computeAnalytics = () => {
    ...
    try {
      ...
      const patients: Patient[] = rawPatients as unknown as Patient[]

      // Fetch all appointments - use hospital-scoped collection
      const appointments: Appointment[] = rawAppointments as unknown as Appointment[]
