...
export const entPartDescriptions: Record<string, { name: string; description: string }> = {
  ...
  Right_Ventricle: { name: 'Right ventricle', description: 'Pumps blood to the lungs.' },
  Right_Atrium: { name: 'Right atrium', description: 'Chamber that receives deoxygenated blood.' },
  Left_Atrium: { name: 'Left atrium', description: 'Chamber that receives oxygenated blood from lungs.' },
  Aorta: { name: 'Aorta', description: 'Main artery carrying blood from the heart.' },
  Left_Pulmonary_Artery: { name: 'Left pulmonary artery', description: 'Carries blood from heart to left lung.' },
  Right_Pulmonary_Artery: { name: 'Right pulmonary artery', description: 'Carries blood from heart to right lung.' },
  Superior_Caval_Vein: { name: 'Superior caval vein', description: 'Large vein bringing blood from upper body to heart.' },
  Inferior_Caval_Vein: { name: 'Inferior caval vein', description: 'Large vein bringing blood from lower body to heart.' },
