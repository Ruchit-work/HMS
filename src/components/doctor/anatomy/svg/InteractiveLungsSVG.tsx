...
// Map text labels in lungs.svg to lungsPartsData keys (16 parts)
const textLabelToPart: Record<string, string> = {
  ...
  'Lung': 'Left_Lung',
  'lungs': 'Left_Lung',
  'Superior lobe': 'Left_Lung',
  'Middle lobe': 'Right_Lung',
  'Inferior lobe': 'Right_Lung',
  'Apex of left lung': 'Left_Lung',
  'Lingula of lung': 'Left_Lung',
  'Diaphragm': 'Left_Lung',
  'Horizontal fissure': 'Right_Lung',
  'Oblique fissure': 'Left_Lung',
  'Pharynx': 'Trachea',
  'pharynx': 'Trachea',
  'Epiglottis': 'Trachea',
  'epiglottis': 'Trachea',
  ...
  'Pulmonary artery': 'Right_Pulmonary_Artery',
  'Pulmonary vein': 'Right_Pulmonary_Vein',
  'Alveoli': 'Left_Lung',
  'Atrium': 'Right_Atrium',
  'Alveolar': 'Left_Lung',
  'Heart': 'Aorta',
